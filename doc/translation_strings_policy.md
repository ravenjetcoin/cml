...
This document provides guidelines for internationalization of the Cryptomiles Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptomiles_en.ts` remains unchanged.
