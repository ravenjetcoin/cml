...
rm -rf ~/cryptomilescoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../cryptomilescoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../cryptomilescoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/cryptomilescoin/temp
cd ~/cryptomilescoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/cryptomilescoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/cryptomilescoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
