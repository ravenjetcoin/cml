...
class TxnMallTest(CryptomilesTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CML:
        ...
        # First: use raw transaction API to send 1240 CML to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CML coin each
        ...
        # Node0's balance should be starting balance, plus 50CML for another
        ...
        # Node0's total balance should be starting balance, plus 100CML for 
