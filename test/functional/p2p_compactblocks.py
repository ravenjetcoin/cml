...
# TestNode: A peer we use to send messages to cryptomilesd, and store responses.
...
class CompactBlocksTest(CryptomilesTestFramework):
    ...
    # This test actually causes cryptomilesd to (reasonably!) disconnect us, so do this last.
    ...
    # cryptomilesd's choice of nonce.
    ...
    # Test that cryptomilesd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cryptomilesd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cryptomilesd will not send blocktxn responses for blocks whose height is
