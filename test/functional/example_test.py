...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CryptomilesTestFramework
    pass

class ExampleTest(CryptomilesTestFramework):
    # Each functional test is a subclass of the CryptomilesTestFramework class.
    ...
    def custom_method(self):
        ...
        CryptomilesTestFramework class so other tests can use it."""
