...
from test_framework.test_framework import CryptomilesTestFramework, SkipTest
...
class ZMQTest (CryptomilesTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that cryptomiles has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("cryptomilesd has not been built with zmq enabled.")
