...
class AssetTest(CryptomilesTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("CRYPTOMILES1", 1000)
        n0.issue("CRYPTOMILES2", 1000)
        n0.issue("CRYPTOMILES3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="CRYPTOMILES*", verbose=False, count=2, start=-2)
        ...
        cryptomiles_assets = n0.listassets(asset="CRYPTOMILES*", verbose=False, count=2, start=-2)
        assert_equal(len(cryptomiles_assets), 2)
        assert_equal(cryptomiles_assets[0], "CRYPTOMILES2")
        assert_equal(cryptomiles_assets[1], "CRYPTOMILES3")
        self.sync_all()
