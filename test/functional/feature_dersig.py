...
class BIP66Test(CryptomilesTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # cryptomilesd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and cryptomilesd produces more specific reject
            # reasons.
