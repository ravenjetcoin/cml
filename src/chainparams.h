...
#ifndef CRYPTOMILES_CHAINPARAMS_H
#define CRYPTOMILES_CHAINPARAMS_H
 ...
 * Cryptomiles system. There are three: the main network on which people trade goods
...
#endif // CRYPTOMILES_CHAINPARAMS_H
