...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(CryptomilesUnits::CML),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->cmlBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->cmlBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(CryptomilesUnits::formatWithUnit(unit, balance, false, CryptomilesUnits::separatorAlways));
    ui->labelUnconfirmed->setText(CryptomilesUnits::formatWithUnit(unit, unconfirmedBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelImmature->setText(CryptomilesUnits::formatWithUnit(unit, immatureBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelTotal->setText(CryptomilesUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelWatchAvailable->setText(CryptomilesUnits::formatWithUnit(unit, watchOnlyBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelWatchPending->setText(CryptomilesUnits::formatWithUnit(unit, watchUnconfBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelWatchImmature->setText(CryptomilesUnits::formatWithUnit(unit, watchImmatureBalance, false, CryptomilesUnits::separatorAlways));
    ui->labelWatchTotal->setText(CryptomilesUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, CryptomilesUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CML")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the CML balance grid from expanding and looking terrible when asset balance is hidden
