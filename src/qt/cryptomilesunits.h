...
#ifndef CRYPTOMILES_QT_CRYPTOMILESUNITS_H
#define CRYPTOMILES_QT_CRYPTOMILESUNITS_H
...
/** Cryptomiles unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CryptomilesUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CryptomilesUnits(QObject *parent);

    /** Cryptomiles units.
      @note Source: https://en.cryptomiles.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CML,
...
typedef CryptomilesUnits::Unit CryptomilesUnit;

#endif // CRYPTOMILES_QT_CRYPTOMILESUNITS_H
