...
#ifndef CRYPTOMILES_QT_WALLETMODEL_H
#define CRYPTOMILES_QT_WALLETMODEL_H
...
/** Interface to Cryptomiles wallet from Qt view code. */
...
#endif // CRYPTOMILES_QT_WALLETMODEL_H
