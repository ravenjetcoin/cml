...
#include "config/cryptomiles-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCryptomilesURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CryptomilesUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCryptomilesURI(info));
}
