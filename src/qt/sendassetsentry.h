...
#ifndef CRYPTOMILES_QT_SENDASSETSENTRY_H
#define CRYPTOMILES_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending cryptomiless.
...
#endif // CRYPTOMILES_QT_SENDASSETSENTRY_H
