...
#ifndef CRYPTOMILES_QT_GUIUTIL_H
#define CRYPTOMILES_QT_GUIUTIL_H
...
/** Utility functions used by the Cryptomiles Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cryptomiles:" URI into recipient object, return true on successful parsing
...
#endif // CRYPTOMILES_QT_GUIUTIL_H
