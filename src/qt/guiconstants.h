...
#ifndef CRYPTOMILES_QT_GUICONSTANTS_H
#define CRYPTOMILES_QT_GUICONSTANTS_H
...
/* CryptomilesGUI -- Size of icons in status bar */
...
/* Cryptomilescoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05339")
/* Cryptomilescoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#f79433")
/* Cryptomilescoin dark blue */
#define COLOR_DARK_BLUE QColor("#475eaa")
/* Cryptomilescoin light blue */
#define COLOR_LIGHT_BLUE QColor("#5874cf")
/* Cryptomilescoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* Cryptomilescoin shadow color - light mode */
...
/* Cryptomilescoin shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* Cryptomilescoin Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* Cryptomilescoin Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* Cryptomilescoin dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* Cryptomilescoin dark mode regular asset background color */
...
/* Cryptomilescoin label color as a string */
...
#define QAPP_ORG_NAME "Cryptomiles"
#define QAPP_ORG_DOMAIN "cryptomiles.org"
#define QAPP_APP_NAME_DEFAULT "Cryptomiles-Qt"
#define QAPP_APP_NAME_TESTNET "Cryptomiles-Qt-testnet"

#endif // CRYPTOMILES_QT_GUICONSTANTS_H
