...
#include "qt/cryptomilesamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CryptomilesAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cryptomiles-qt -platform xcb      # Linux
//     src/qt/test/test_cryptomiles-qt -platform windows  # Windows
//     src/qt/test/test_cryptomiles-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CryptomilesUnits::formatWithUnit(unit, balance, false, CryptomilesUnits::separatorAlways);
    ...
    // Amount input
    CryptomilesAmountField* amountInput = receiveCoinsDialog.findChild<CryptomilesAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cryptomiles:")) != -1);
