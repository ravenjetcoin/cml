...
#ifndef CRYPTOMILES_CONSENSUS_CONSENSUS_H
#define CRYPTOMILES_CONSENSUS_CONSENSUS_H
...
static const int COINBASE_MATURITY = 9;
...
#endif // CRYPTOMILES_CONSENSUS_CONSENSUS_H
