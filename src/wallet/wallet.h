...
#ifndef CRYPTOMILES_WALLET_WALLET_H
#define CRYPTOMILES_WALLET_WALLET_H
...
public:
     ...
     * on this cryptomiles node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapAssetCoins,
                            bool fGetCML = true, bool fOnlyAssets = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and CML
     */
...
#endif // CRYPTOMILES_WALLET_WALLET_H
