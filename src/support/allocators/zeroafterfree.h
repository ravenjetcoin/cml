...
#ifndef CRYPTOMILES_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CRYPTOMILES_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CRYPTOMILES_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
