...
#ifndef CRYPTOMILES_SCRIPT_SCRIPT_H
#define CRYPTOMILES_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Cryptomiles always counted CHECKMULTISIGs
...
#endif // CRYPTOMILES_SCRIPT_SCRIPT_H
