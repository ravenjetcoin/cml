...
#ifndef CRYPTOMILES_TEST_SCRIPTNUM10_H
#define CRYPTOMILES_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cryptomiles Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CRYPTOMILES_TEST_BIGNUM_H
