#!/usr/bin/env python3
# Script to issue assets on the Cryptomilescoin platform
...
# Prerequisite: cryptomilesd daemon to be running
...
#Set this to your cryptomiles-cli program
cli = "cryptomiles-cli"
...
#Set this information in your cryptomiles.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
